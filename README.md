...
## Прочитанные книги
**Python и архитектура:**
- *Изучаем Python (Марк Лутц, 5-е изд.)*  
- *Python. К вершинам мастерства (Лусиану Ромальо)*  
- *Рецепты Python (Юн Цуй)*  
- *Мощный Python (Аарон Максвелл)*  
...
- *Чистый код*, *Чистая архитектура*, *Идеальный программист*, *Чистый Agile* — Роберт Мартин  
- *Изучаем DDD* — Влад Хононов  
- *Паттерны разработки на Python* — Гарри Персиваль, Боб Грегори  

**Общие книги по CS и системному дизайну:**
- *System Design* — Алекс Сюй  
- *Теоретический минимум по Computer Science* — Фило Владстон Феррейра  
- *Грокаем алгоритмы* — Адитья Бхаргава  
- *Алгоритмы неформально* — Брэдфорд Такфилд  
- *Код. Тайный язык информатики* — Чарльз Петцольд  
- *Время Unix* — Брайан Крениган  

**Инструменты и практика:**
- *PostgreSQL. Основы языка SQL* — Е. П. Моргунов  
- *Head First Git* — Раджу Ганди  
- *Git. Контроль версий* — Прем Кумар Понуторай, Джон Лолигер  
...
- *Как разговаривать с кем угодно* — Ларри Кинг  
