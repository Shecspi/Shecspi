...
3. Мэттью Фаулер - **Asyncio и конкурентное программирование на Python**
4. Роберт Мартин - **Чистая архитектура**
5. Гарри Персиваль, Боб Грегори - **Паттерны разработки на Python**
6. Адитья Бхаргава - **Грокаем алгоритмы**
7. Брэдфорд Такфилд - **Алгоритмы неформально**
8. Е.П.Моргунов, **PostgreSQL. Основы языка SQL**
9. Влад Хононов - **Изучаем DDD - предметно-ориентированное проектирование**
